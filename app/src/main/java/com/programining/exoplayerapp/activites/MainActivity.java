package com.programining.exoplayerapp.activites;
...
import com.programining.exoplayerapp.R;
import com.programining.exoplayerapp.interfaces.MediatorInterface;
...
public class MainActivity extends AppCompatActivity implements MediatorInterface {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // changeFragmentTo(new FragmentClass(), SoundRecordFragment.class.getSimpleName());
    }
